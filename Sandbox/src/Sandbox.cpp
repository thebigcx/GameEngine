...
void Sandbox::onUpdate(float dt)
{
    ...
    Renderer2D::renderQuad(math::vec2(0, 0), math::vec2(100, 100), math::vec4(0, 1, 0, 1));
    Renderer2D::renderText("Hello, world!", m_font, math::vec2(0, 0), math::vec2(80, 80), math::vec4(1, 0, 0, 1));
    Renderer2D::endScene();
